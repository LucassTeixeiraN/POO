...
class Employee(Person):
    ...
    def __init__(self, name, cpf, rg, phone, type, sectorCode, baseSalary, tax):
    ...
    def calculateSalary(self, commission):
        return self.getBaseSalary() - (self.getTax()/100)*self.getBaseSalary() + commission
